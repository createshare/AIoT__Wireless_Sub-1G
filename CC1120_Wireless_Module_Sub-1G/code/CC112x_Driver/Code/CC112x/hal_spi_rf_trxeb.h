...
#define TRXEM_PORT_SEL       P8SEL
#define TRXEM_PORT_OUT       P8OUT
#define TRXEM_PORT_DIR       P8DIR
#define TRXEM_PORT_IN        P8IN

#define TRXEM_SPI_MOSI_PIN   BIT5
#define TRXEM_SPI_MISO_PIN   BIT6
#define TRXEM_SPI_SCLK_PIN   BIT4
#define TRXEM_SPI_SC_N_PIN   BIT1
...
//==GPIO3 Ó²¼þ¶¨Òå====================================
#define TRXEM_GPIO3_SEL    P1SEL
#define TRXEM_GPIO3_DIR    P1DIR
#define TRXEM_GPIO3_IES    P1IES
#define TRXEM_GPIO3_IFG    P1IFG 
#define TRXEM_GPIO3_IE     P1IE

#define TRXEM_GPIO3_IO     (BIT0)
